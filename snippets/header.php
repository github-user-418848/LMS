        ...
        <ul class="menu">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="<?=BASE_URL?>/librarian/pending_books.php" <?=CheckActiveUrl("librarian/pending_books")?>>Issued</a>
                </div>
            </li>
        ...
        <ul class="menu">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="<?=BASE_URL?>/member/pending_books.php" <?=CheckActiveUrl("member/pending_books")?>>Issued</a>
                </div>
            </li>
